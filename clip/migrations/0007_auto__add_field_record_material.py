...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.material'
        db.add_column(u'clip_record', 'material',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['clip.Material']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.material'
        db.delete_column(u'clip_record', 'material_id')
    ...
    models = {
        ...
        u'clip.record': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'material': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['clip.Material']"})
        },
